...
async function main() {
    ...
    // Create agent
    const agent = await (0, relay_client_1.createRelayClient)('code_reviewer_001');
    // Define capabilities
    const manifest = {
    ...
    console.log(`📊 Reputation: ${(reputation.overallScore * 100).toFixed(1)}% (${reputation.tier || 'unranked'})`);
